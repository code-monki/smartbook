...
[X] Creator Tool tests
  ...
  [X] T-CT-27 through T-CT-30: Form Builder (test_formbuilder.cpp - tests exist, some failures to fix)
  [X] T-CT-10 through T-CT-21: Cartridge Exporter (test_cartridgeexporter.cpp - tests exist)
  [X] T-CT-22 through T-CT-26: Metadata Editor (test_metadataeditor.cpp - tests exist)
  [X] Page Manager tests (test_pagemanager.cpp - tests exist, some failures to fix)
