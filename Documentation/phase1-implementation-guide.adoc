...
[X] Creator Tool tests
  ...
  [X] T-CT-27 through T-CT-30: Form Builder (test_formbuilder.cpp - tests exist, 1 failure in initTestCase)
  ...
  [X] Page Manager tests (test_pagemanager.cpp - tests exist, 1 failure)
