...
| `remote_only` | Cloud icon (☁️) - indicates remote only
| `both` | Checkmark + Cloud icon (✓☁️) - indicates synced
| `local_modified` | Warning icon (⚠️) - local copy modified
| `remote_updated` | Update icon (🔄) - remote has newer version
|===
