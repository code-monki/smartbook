...
a|
**AC:** The call returns `TRUE` immediately. [cite_start]No native modal dialog is displayed[cite: 6].
| Expected Result (Acceptance Criteria) |
a|
|===
...
| Expected Result (Acceptance Criteria) |
a|
[cite_start]**AC:** The native security dialog (DDD 11.2.1) is displayed, clearly showing the App Name and the three consent options[cite: 8].
| Expected Result (Acceptance Criteria) |
a|
|===
...
| Expected Result (Acceptance Criteria) |
a|
[cite_start]**AC:** A `PERSISTENT` record is written to `Local_Trust_Registry`[cite: 10]. [cite_start]The second load skips the dialog, and the consent call returns `TRUE`[cite: 11].
| Expected Result (Acceptance Criteria) |
a|
|===
...
| Expected Result (Acceptance Criteria) |
a|
**AC:** The `SignatureVerifier` blocks the load. [cite_start]An "Rejected (Tampered)" error is displayed[cite: 13]. [cite_start]Content is **not rendered** and the `requestAppConsent()` returns `FALSE`[cite: 14].
| Expected Result (Acceptance Criteria) |
a|
|===
...
| Expected Result (Acceptance Criteria) |
a|
[cite_start]**AC:** The `Local_Trust_Registry` record is set to `app_trust_policy: REVOKED`[cite: 16]. [cite_start]The next load forces the user to re-consent (T-SEC-02)[cite: 17].
| Expected Result (Acceptance Criteria) |
a|
|===
...
| Expected Result (Acceptance Criteria) |
a|
[cite_start]**AC:** A new entry exists containing the correct `cartridge_guid`, `cartridge_hash` (H2), `local_path`, and the required `publication_year`[cite: 20].
| Expected Result (Acceptance Criteria) |
a|
|===
...
| Expected Result (Acceptance Criteria) |
a|
**AC:** Both windows remain responsive. [cite_start]Data saved in B is isolated to B's `User_Data` table, confirming the per-instance nature of `CartridgeDBConnector`[cite: 23, 24].
| Expected Result (Acceptance Criteria) |
a|
|===
...
| Expected Result (Acceptance Criteria) |
a|
[cite_start]**AC:** The cartridge file is deleted[cite: 25]. [cite_start]The corresponding rows are removed atomically from **both** `Local_Library_Manifest` and `Local_Trust_Registry`[cite: 26].
| Expected Result (Acceptance Criteria) |
a|
|===
...
| Expected Result (Acceptance Criteria) |
a|
[cite_start]**AC:** The Library View loads and displays all required metadata fields (Title, Author, Year, etc.) within **500 milliseconds**[cite: 28].
| Expected Result (Acceptance Criteria) |
a|
|===
...
| Expected Result (Acceptance Criteria) |
a|
[cite_start]**AC:** Both views load instantly[cite: 30]. [cite_start]The List-View displays the required columns (Title, Author, Edition/Version, Year of Publication) sourced from the manifest[cite: 31].
| Expected Result (Acceptance Criteria) |
a|
|===
...
|===
| Test Case ID | Test Case ID
| Requirement Covered | **T-SERIES-01**
| Test Steps |
a|
...
|===
| Test Case ID | Test Case ID
| Requirement Covered | **T-SERIES-02**
| Test Steps |
a|
...
|===
| Test Case ID | Test Case ID
| Requirement Covered | **T-SERIES-03**
| Test Steps |
a|
...
|===
| Test Case ID | Test Case ID
| Requirement Covered | **T-SERIES-04**
| Test Steps |
a|
...
|===
| Test Case ID | Test Case ID
| Requirement Covered | **T-SERIES-05**
| Test Steps |
a|
...
|===
| Test Case ID | Test Case ID
| Requirement Covered | **T-SERIES-06**
| Test Steps |
a|
...
|===
| Test Case ID | Test Case ID
| Requirement Covered | **T-SERIES-07**
| Test Steps |
a|
...
|===
| Test Case ID | Test Case ID
| Requirement Covered | **T-SERIES-08**
| Test Steps |
a|
...
|===
| Test Case ID | Test Case ID
| Requirement Covered | **T-SERIES-09**
| Test Steps |
a|
...
|===
| Test Case ID | Test Case ID
| Requirement Covered | **T-SERIES-10**
| Test Steps |
a|
...
|===
| Test Case ID | Test Case ID
| Requirement Covered | **T-SERIES-11**
| Test Steps |
a|
...
|===
| Test Case ID | Test Case ID
| Requirement Covered | **T-SERIES-12**
| Test Steps |
a|
...
|===
| Test Case ID | Test Case ID
| Requirement Covered | **T-SERIES-13**
| Test Steps |
a|
...
|===
| Test Case ID | Test Case ID
| Requirement Covered | **T-SERIES-14**
| Test Steps |
a|
...
|===
| Test Case ID | Test Case ID
| Requirement Covered | **T-SERIES-15**
| Test Steps |
a|
